...
| Case-study source | [opencasestudies/ocs-bio-temporal](https://github.com/opencasestudies/ocs-bio-temporal){target="_blank"} | Source files, included teaching artifacts, scripts, and website output. |
...
| Runtime image | `othomas2/cs5-cogaps-runtime:0.1.0` | Docker image used for RStudio Server sessions and optional local reproduction. |
