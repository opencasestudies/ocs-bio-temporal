...
::::
::::{.inner_block}
- {{< glossary "Preprocessing" display="Preprocessing" >}} turns imported single-cell data into a model-ready object whose cells, genes, metadata, and file origins can be interpreted together.
...
For the full parameter-level reference, see [Advanced Audit: Full Preprocessing Decision Reference](#advanced-audit-full-preprocessing-decision-reference) in the Full Reproduction Guide. The shorter explanation here is the part you need to carry forward: these choices do not prove a biological program, but they define the evidence that can be interpreted later.
