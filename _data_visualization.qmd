...
Data Import has already established why the case study follows the selected `K = 10` model. Data Exploration checked coverage, composition, and model-evidence tables. Data Wrangling and Preprocessing then connected the selected-model outputs to subject-timepoint summaries and identity/activity evidence.
